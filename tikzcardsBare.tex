...
\newcommand{\cardcontent}[1]{
    %\node[text width=4.5cm] at (\cardwidth/2, 0.35*\cardheight) {#1};
		\node[text width=4.4cm, below right] at (\stripwidth*1.1, 0.25*\cardheight) {\textrm{\Large#1}};
}

\newcommand{\cardimage}[1]{
	\node at (\cardwidth*.5, \cardheight*.75) {\includegraphics[height = 2.5cm]{#1}};
}
...
\newcommand{\attributes}[3]{
	\node at (.5*\cardwidth, .4*\cardheight) {\includegraphics[height=1.5cm]{#1} \includegraphics[height=1.5cm]{#2} \includegraphics[height=1.5cm]{#3}};
}
