...
\newcommand{\cardbackground}[1]{
    ...
    %\node at (\cardwidth/2, \cardheight/2) {\includegraphics[height = 9.5cm]{#1}};
		\node[rotate=270] at (5,6) {\textbf{\Large{\uppercase{#1}}}};
...
\newcommand{\cardcontent}[1]{
    %\node[text width=4.5cm] at (\cardwidth/2, 0.35*\cardheight) {#1};
		\node[text width=5.5cm, below right] at (\stripwidth*.5, 0.3*\cardheight) {\textrm{\Large#1}};
}

\newcommand{\cardimage}[1]{
	\node at (\cardwidth*.5, \cardheight*.75) {\includegraphics[height = 2.5cm]{heroes/#1}};
}
...
\newcommand{\attributes}[3]{
	\node at (.5*\cardwidth, .4*\cardheight) {\includegraphics[height=1.3cm]{#1} \includegraphics[height=1.3cm]{#2} \includegraphics[height=1.3cm]{#3}};
}
